		...
		<div className='w-full max-w-md mx-auto px-4 sm:px-0'>
			<form onSubmit={formik.handleSubmit} className='space-y-4 sm:space-y-6'>
				...
				<div>
					...
					<div className='relative'>
						...
						<input
							...
							className={`
                                block w-full pl-9 sm:pl-10 pr-3 py-3 sm:py-3
				...
				<button
					...
					className='
                        w-full flex justify-center py-3 sm:py-3 px-4
					...
					{formik.isSubmitting ? (
						<div className='flex items-center'>
							<div className='animate-spin rounded-full h-4 w-4 sm:h-5 sm:w-5 border-2 border-gray-900 border-t-transparent mr-2'></div>
							<span className='text-sm sm:text-base'>Logowanie...</span>
						</div>
					) : (
						<span className='text-sm sm:text-base'>Zaloguj się</span>
					)}
				</button>
			</form>
		</div>
